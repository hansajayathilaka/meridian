...
- **NOW:** Phase 1 fix-tasks landing — 1.1 (ADR 0015 ratchet composition), 1.2 (doc-sync) done.
- **NEXT:** run **`/next-task`** to continue with 1.3 (reconcile T03/T04/T05 specs), then the rest.
