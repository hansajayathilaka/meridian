...
- [`meridian` CLI/TUI native executables (Linux + Windows)](./release-binaries.md) — the **client**
  binary release channel (download-and-run `meridian tui`), independent of the Docker image above.
